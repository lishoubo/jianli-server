...
public class JLView {
    ...
    private DesignDocument.MapReduce mapRedtempViewM; // temp view

    public JLView(CouchDbClientBase dbc, String viewId) {
        this.dbc = dbc;
    ...
    public <K, V, T> ViewResult<K, V, T> queryView(Class<K> classOfK, Class<V> classOfV, Class<T> classOfT) {
        InputStream instream = null;
        try {
            Reader reader = new InputStreamReader(instream = queryForStream(), CHARSET);
     ...
     */
    public JLView startKey(Object... startKey) {
        this.startKey = getKeyAsJson(startKey);
        uriBuilder.query("startkey", this.startKey);
        return this;
    }

    public JLView startKeyDocId(String startKeyDocId) {
     ...
     */
    public JLView stale(String stale) {
        this.stale = stale;
     ...
     */
    public JLView descending(Boolean descending) {
     ...
     */
    public JLView skip(Integer skip) {
        this.skip = skip;
     ...
     */
    public JLView group(Boolean group) {
        this.group = group;
        uriBuilder.query("group", this.group);
        return this;
    }

    public JLView groupLevel(Integer groupLevel) {
     ...
     */
    public JLView reduce(Boolean reduce) {
        this.reduce = reduce;
        uriBuilder.query("reduce", this.reduce);
        return this;
    }

    public JLView includeDocs(Boolean includeDocs) {
     ...
     *                     defaults to true.
     */
    public JLView inclusiveEnd(Boolean inclusiveEnd) {
        this.inclusiveEnd = inclusiveEnd;
        uriBuilder.query("inclusive_end", this.inclusiveEnd);
        return this;
    }

    public JLView updateSeq(Boolean updateSeq) {
     ...
     * @return
     */
    public JLView keys(List<String> keys) {
    ...
    public JLView tempView(String id) {
        ...
        mapRedtempViewM = new DesignDocument.MapReduce();
    ...
    public JLView tempView(DesignDocument.MapReduce mapReduce) {
