...
public enum StatusCode {
	SUCCESS(200, "SUCCESS", "处理成功"), CLIENT_INVALID_REQUEST(300,
			"CLIENT INVALID REQUEST", "不合法的客户端请求"), DATA_INVALID_SAME_NAME_STAFF(
			400, "STAFF NAME DUPLICATED", "工程师重名"), NOT_FOUND_STAFF(401,
